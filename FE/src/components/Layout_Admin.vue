    ...
    >
      ...
      >
        ...
        <div :class="sidebarExpanded ? 'w-full flex flex-col gap-1' : 'px-2 flex flex-col items-center gap-1'">
          ...
          <SidebarItem :expanded="sidebarExpanded" :is-active="isActive('/admin/phanca')" icon="edit_calendar" label="Phân ca làm việc" :is-dark="isDark" to="/admin/phanca" @click="handleNavClick" />          <SidebarItem :expanded="sidebarExpanded" :is-active="isActive('/admin/giam-sat-gps')" icon="pin_drop" label="Giám sát Geofence" :is-dark="isDark" to="/admin/giam-sat-gps" @click="handleNavClick" />
