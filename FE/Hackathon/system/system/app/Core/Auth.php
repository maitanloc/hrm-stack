...
class Auth
{
    public static function attempt(string $employeeCode, string $companyEmail): array
    {
        $sql = 'SELECT employee_id, employee_code, full_name, company_email, status
                FROM employees
                WHERE employee_code = :employee_code AND company_email = :company_email
                LIMIT 1';
