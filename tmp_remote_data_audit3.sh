...
mysqlq "SELECT request_type_id, request_type_code, request_type_name, category, description FROM request_types ORDER BY request_type_id;"
echo "-- leave_types columns --"
mysqlq "SHOW COLUMNS FROM leave_types;"
echo "-- leave_types sample --"
mysqlq "SELECT leave_type_id, leave_type_code, leave_type_name, paid_leave, requires_medical_cert FROM leave_types ORDER BY leave_type_id;"
